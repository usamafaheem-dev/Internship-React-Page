      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-0">
          {steps.map((step, index) => (
            <div key={index}>
              <div className="py-8 md:py-12 grid grid-cols-1 md:grid-cols-[120px_1fr] gap-4 md:gap-8 lg:gap-12">
                {/* Number */}
                <div className="text-5xl md:text-6xl lg:text-7xl font-bold text-lime-500">
                  {step.number}
                </div>
        ...
        <div className="flex justify-center mt-12 md:mt-16">
          <button className="bg-lime-500 hover:bg-lime-600 text-black font-semibold px-8 py-3 md:px-10 md:py-4 transition-colors duration-200">
            APPLICATION FORM →
          </button>
        </div>
      </div>
