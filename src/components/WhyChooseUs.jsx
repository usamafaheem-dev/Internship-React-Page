...
const WhyChooseUs = () => {
  ...
  return (
    <section className="relative bg-gray-50 py-16 md:py-20 lg:py-24 px-6 md:px-8 z-10">
        ...
        <div className="flex flex-col md:grid md:grid-cols-3 md:gap-x-8 lg:gap-x-12 md:gap-y-12 lg:gap-y-16 space-y-10 md:space-y-0">
          {features.map((feature) => (
            <div key={feature.id} className="flex flex-col items-center text-center">
              {/* Icon Circle */}
              <div className="w-20 h-20 md:w-24 md:h-24 rounded-full bg-[#9DC023] flex items-center justify-center mb-5 md:mb-6">
                {feature.icon}
              </div>
